...
ruby snapp_prep.rb -p ../data/alignments/ariidae.phy -t ../data/tables/species.txt -c ../data/constraints/constraints.txt -s ../data/trees/starting.tre -x ../data/xml/ariidae.xml -o ariidae

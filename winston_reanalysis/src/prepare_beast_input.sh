...
ruby beauti.rb -id eciton_concatenated -n ../data/alignments/nexus -o ../data/xml -c ../data/constraints/constraints.xml -m GTR -g -t ../data/trees/starting.tre -l 200000
